...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geo2d/circle_line_crosspoint.test.cpp\"\n\
    ...
    \                    c1.p + u * polar(c1.r, -a),\n                    c2.p - s\
    \ * u * polar(c2.r, -a));\n        }\n    }\n    return lines;\n}\n\n} // namespace\
    \ geo2d\n#line 5 \"test/geometry/geo2d/circle_line_crosspoint.test.cpp\"\nusing\
    \ namespace geo2d;\n\nint main()\n{\n    cout << fixed << setprecision(10);\n\n\
    \    double x, y, r;\n    cin >> x >> y >> r;\n    Circle c(Point(x, y), r);\n\
    \n    int q; cin >> q;\n    while (q--) {\n        double x1, y1, x2, y2;\n  \
    \      cin >> x1 >> y1 >> x2 >> y2;\n\n        Point p1, p2;\n        tie(p1,\
    \ p2) = crosspoint(c, Line(Point(x1, y1), Point(x2, y2)));\n        if (p2 < p1)\
  ...
  verifiedWith: []
documentation_of: test/geometry/geo2d/circle_line_crosspoint.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geo2d/circle_line_crosspoint.test.cpp
- /verify/test/geometry/geo2d/circle_line_crosspoint.test.cpp.html
