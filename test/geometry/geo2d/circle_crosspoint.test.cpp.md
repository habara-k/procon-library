...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geo2d/circle_crosspoint.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_E\"\
    ...
    \                    c1.p + u * polar(c1.r, -a),\n                    c2.p - s\
    \ * u * polar(c2.r, -a));\n        }\n    }\n    return lines;\n}\n\n} // namespace\
    \ geo2d\n#line 5 \"test/geometry/geo2d/circle_crosspoint.test.cpp\"\nusing namespace\
  ...
  verifiedWith: []
documentation_of: test/geometry/geo2d/circle_crosspoint.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geo2d/circle_crosspoint.test.cpp
- /verify/test/geometry/geo2d/circle_crosspoint.test.cpp.html
