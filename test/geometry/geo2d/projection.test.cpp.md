...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/geo2d/projection.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_1_A\"\n#define\
    ...
    \                    c1.p + u * polar(c1.r, -a),\n                    c2.p - s\
    \ * u * polar(c2.r, -a));\n        }\n    }\n    return lines;\n}\n\n} // namespace\
    \ geo2d\n#line 5 \"test/geometry/geo2d/projection.test.cpp\"\nusing namespace\
    \ geo2d;\n\nint main()\n{\n    cout << fixed << setprecision(10);\n\n    double\
    \ x1, y1, x2, y2;\n    cin >> x1 >> y1 >> x2 >> y2;\n    Segment l{Point{x1, y1},\
    \ Point{x2, y2}};\n    int q; cin >> q;\n    while (q--) {\n        double x,\
  ...
  verifiedWith: []
documentation_of: test/geometry/geo2d/projection.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/geo2d/projection.test.cpp
- /verify/test/geometry/geo2d/projection.test.cpp.html
