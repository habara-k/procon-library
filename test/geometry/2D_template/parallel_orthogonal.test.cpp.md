...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/2D_template/parallel_orthogonal.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/2/CGL_2_A\"\
    ...
    \ y4;\n        cin >> x1 >> y1 >> x2 >> y2 >> x3 >> y3 >> x4 >> y4;\n        Segment\
    \ l1{Point{x1, y1}, Point{x2, y2}},\n                l2{Point{x3, y3}, Point{x4,\
    \ y4}};\n\n        if (parallel(l1, l2)) {\n            cout << 2 << endl;\n \
    \       } else if (orthogonal(l1, l2)) {\n            cout << 1 << endl;\n   \
    \     } else {\n            cout << 0 << endl;\n        }\n    }\n\n    return\
    \ 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/geometry/2D_template/parallel_orthogonal.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/2D_template/parallel_orthogonal.test.cpp
- /verify/test/geometry/2D_template/parallel_orthogonal.test.cpp.html
