...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/2D_template/projection.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_1_A\"\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_1_A\"\
    ...
    \ x2, y2;\n    cin >> x1 >> y1 >> x2 >> y2;\n    Segment l{Point{x1, y1}, Point{x2,\
    \ y2}};\n    int q; cin >> q;\n    while (q--) {\n        double x, y; cin >>\
    \ x >> y;\n        Point p{x, y};\n        Point c = projection(l, p);\n     \
  ...
  verifiedWith: []
documentation_of: test/geometry/2D_template/projection.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/2D_template/projection.test.cpp
- /verify/test/geometry/2D_template/projection.test.cpp.html
