...
data:
  ...
  bundledCode: "#line 1 \"test/geometry/polygon/convex_cut.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/4/CGL_4_C\"\n#define\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/4/CGL_4_C\"\
    ...
    \    vector<Point> p(n);\n    for (int i = 0; i < n; ++i) {\n        double x,\
    \ y; cin >> x >> y;\n        p[i] = { x, y };\n    }\n\n    int q; cin >> q;\n\
    \    for (int i = 0; i < q; ++i) {\n        double x1, y1, x2, y2; cin >> x1 >>\
    \ y1 >> x2 >> y2;\n        Point p1 = { x1, y1 }, p2 = { x2, y2 };\n        Polygon\
    \ c = convex_cut(p, Line{ p1, p2 });\n        cout << area(convex_cut(p, Line{\
    \ p1, p2 })) << endl;\n    }\n\n    return 0;\n}\n"
  dependsOn:
  - lib/geometry/polygon.cpp
  ...
  verifiedWith: []
documentation_of: test/geometry/polygon/convex_cut.test.cpp
layout: document
redirect_from:
- /verify/test/geometry/polygon/convex_cut.test.cpp
- /verify/test/geometry/polygon/convex_cut.test.cpp.html
