...
data:
  ...
  - test/geometry/geo2d/common_tangent.test.cpp
  - test/geometry/geo2d/crosspoint.test.cpp
  - test/geometry/geo2d/parallel_orthogonal.test.cpp
  - test/geometry/geo2d/circle_intersection.test.cpp
  - test/geometry/geo2d/projection.test.cpp
  - test/geometry/geo2d/distance.test.cpp
  - test/geometry/geo2d/circle_line_crosspoint.test.cpp
  - test/geometry/geo2d/tangent.test.cpp
  - test/geometry/geo2d/intersection.test.cpp
  - test/geometry/geo2d/counter_clockwise.test.cpp
  - test/geometry/geo2d/circle_crosspoint.test.cpp
documentation_of: lib/geometry/geo2d.cpp
layout: document
redirect_from:
- /library/lib/geometry/geo2d.cpp
- /library/lib/geometry/geo2d.cpp.html
